...
OpenLayers.Control.Magnifier = OpenLayers.Class(OpenLayers.Control, {
    ...
    drag: function(px) {
        if (this.handlers.drag.lastMoveEvt.target == this.factorDisplay.div) {
            this.div.style.width = this.div.style.width ? this.div.style.width : getComputedStyle(this.div).width;
            this.div.style.height = this.div.style.height ? this.div.style.height : getComputedStyle(this.div).height;
            this.div.style.width = parseInt(this.div.style.width) + (px.x - this.handlers.drag.last.x) + 'px';
            this.div.style.height = parseInt(this.div.style.height) + (px.y - this.handlers.drag.last.y) + 'px';
        } else {
            // move
